    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monitor_level', models.CharField(max_length=10, verbose_name='\u544a\u8b66\u7ea7\u522b', choices=[(b'3', '\u8f7b\u5fae'), (b'2', '\u666e\u901a'), (b'1', '\u4e25\u91cd')])),
                ...
                ('monitor_config', models.TextField(help_text='\u8be5\u5b57\u6bb5\u5e9f\u5f03\uff0c\u4e0d\u518d\u4f7f\u7528', verbose_name='\u901a\u77e5\u53c2\u6570')),
                ('rules', models.TextField(verbose_name='\u6536\u655b\u89c4\u5219')),
                ('display_name', models.CharField(default=b'', max_length=50, verbose_name='\u7b56\u7565\u540d\u79f0')),
                ('responsible', models.TextField(default=b'', null=True, verbose_name='\u989d\u5916\u901a\u77e5\u4eba', blank=True)),
                ('solution_id', models.CharField(default=b'', max_length=30, null=True, verbose_name='\u81ea\u6108\u5957\u9910id', blank=True)),
                ('notify_way', models.TextField(verbose_name='\u901a\u77e5\u65b9\u5f0f')),
                ('role_list', models.TextField(verbose_name='\u901a\u77e5\u4eba\u89d2\u8272')),
                ('prform_cate', models.CharField(default=b'', max_length=30, null=True, verbose_name='\u57fa\u7840\u6027\u80fd\u914d\u7f6e', blank=True)),
                ...
                ('nodata_alarm', models.IntegerField(default=0, verbose_name='\u65e0\u6570\u636e\u544a\u8b66(\u8fde\u7eed\u591a\u5c11\u5468\u671f)')),
                ...
                ('scenario', models.CharField(default=b'custom', max_length=32, verbose_name='\u76d1\u63a7\u573a\u666f')),
            ],
            options={
