    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default=b'starting', max_length=16, verbose_name='\u4f5c\u4e1a\u72b6\u6001', choices=[(b'starting', '\u542f\u52a8\u4e2d'), (b'running', '\u6b63\u5728\u8fd0\u884c'), (b'stopping', '\u505c\u6b62\u4e2d'), (b'not running', '\u672a\u542f\u52a8')])),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('result_table_id', models.CharField(max_length=64, serialize=False, verbose_name='result table id', primary_key=True)),
                ('biz_id', models.IntegerField(verbose_name='\u4e1a\u52a1ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.CharField(max_length=32, null=True, verbose_name='\u4e2d\u6587\u540d\u79f0', blank=True)),
                ...
                ('is_dimension', models.BooleanField(default=False, verbose_name='\u662f\u5426\u7ef4\u5ea6\u5b57\u6bb5')),
