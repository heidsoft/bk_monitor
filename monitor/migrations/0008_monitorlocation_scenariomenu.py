    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('graph_index', models.IntegerField(default=9999999, verbose_name='\u56fe\u8868\u6240\u5728\u680f\u76ee\u4f4d\u7f6e')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_user', models.CharField(max_length=32, verbose_name='\u4fee\u6539\u4eba')),
                ('is_deleted', models.BooleanField(default=False, verbose_name='\u662f\u5426\u5220\u9664')),
                ('system_menu', models.CharField(default=b'', max_length=32, verbose_name='\u7cfb\u7edf\u83dc\u5355\u680f', choices=[('', '\u7528\u6237\u81ea\u5b9a\u4e49'), ('favorite', '\u5173\u6ce8'), ('default', '\u9ed8\u8ba4\u5206\u7ec4')])),
                ('biz_id', models.CharField(max_length=100, verbose_name='\u4e1a\u52a1ID')),
